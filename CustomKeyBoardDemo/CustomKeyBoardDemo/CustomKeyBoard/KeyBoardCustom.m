    ...
    if (self) {
        ...
        switch (type) {
            case 0:
                ...
                break;
            case 1:
                [self numberIntegerShowtypeGo:tf];
                break;
...
-(void)numberIntegerShowtypeGo:(UITextField *)tfPass{
    ...
    CustomKeyBoardItem *itemDown=[[CustomKeyBoardItem alloc]initWithFrame:CGRectMake(KScreenKeyBoardNumberItemWidth *1, KScreenKeyBoardNumberItemHeight *3, KScreenKeyBoardNumberItemWidth *2, KScreenKeyBoardNumberItemHeight) Image:@"keybord_down" Text:nil RightLine:YES tagSign:11 ItemClick:^(NSInteger tagSign) {
        
        [weakTF resignFirstResponder];
    }];
    
    CustomKeyBoardItem *itemBack=[[CustomKeyBoardItem alloc]initWithFrame:CGRectMake(KScreenKeyBoardNumberItemWidth *3, 0, KScreenKeyBoardNumberItemWidth, KScreenKeyBoardNumberItemHeight *2) Image:@"backspace" Text:nil RightLine:NO tagSign:12 ItemClick:^(NSInteger tagSign) {
